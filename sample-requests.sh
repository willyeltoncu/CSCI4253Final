...
#
REST=${REST:-"localhost:5000"} ## Repalce with public IP for google cloud > kubectl decribe ingress rest-ingress
##Create and delete cluster on google cloud or it will cost money
# echo "Send sentences to analyze"
# curl -X POST -H "Content-Type: application/json" HTTP://$REST/apiv1/load -d@- << __EOF__
# {
#     "model" : "sentiment",
#     "sentences" : [
#         "Happy Thanksgiving",
...
echo "====================="
echo "Dump cache..."
curl -X GET -H "Content-Type: application/json" "HTTP://$REST/apiv1/load"
echo ""
